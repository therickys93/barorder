...
public class BarOrderInfoTest {
	...
	public void testPaths() {
		...
		assertEquals("/productsWithPrice", BarOrderInfo.productsWithPricePath());
	}
	...
	public void testPathOutput() {
		...
		assertEquals("Started class it.therickys93.barorder.endpoints.ProductsWithPrice @ /v1/productsWithPrice", BarOrderInfo.productsWithPricePathInfo());
	}
